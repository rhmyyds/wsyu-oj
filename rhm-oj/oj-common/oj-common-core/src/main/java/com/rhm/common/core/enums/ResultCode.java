...
public enum ResultCode {
    // 苍穹外卖好像只要了文字，没有状态码，苍穹外卖是配合异常和返回结果用的这些静态常量
    SUCCESS (1000, "操作成功"),
    //服务器内部错误，友好提⽰
    ...
    FAILED_FREQUENT (3106, "操作频繁"),
    FAILED_TIME_LIMIT (3107, "当天请求次数达到上限"),
    ...
    EXAM_STARTED(3205,"竞赛已经开始了，无法编辑操作"),
    EXAM_NOT_HAS_QUESTION(3206,"竞赛当中不包含题目"),
    EXAM_IS_FINISH(3207,"竞赛已经结束不能操作"),
    EXAM_IS_PUBLISH(3208,"竞赛已经发布不能编辑删除操作"),
    USER_EXAM_HAS_ENTER (3301,"已经报名过了,无需重复报名"),
    ...
    FAILED_RABBIT_PRODUCE(3701,"mq⽣产者发送消息异常");
    private int code;
    private String msg;
}