<template>
    <div class="login-page">
        ...
        <div class="login-box">
            <div class="logo-box">
                <div class="right">
                    <div class="sys-name">冉汉梦OJ后台管理</div>
                    <div class="sys-sub-name">仿wsyu在线oj项目</div>
                </div>
            </div>
            <div class="form-box">
                <div class="form-item">
                ...
                <div class="form-item">
                    ...
                    <el-input v-model="password" show-password placeholder="请输⼊密码" />
                </div>
...
<script setup>
import { ref } from 'vue'
import { loginService } from '@/api/suser'
