            ...
            <el-form-item prop="nickName">
              <div class="photo-image-box">
                <div class="photo-image">
                  <div class="left">
                    <img width="80px" v-if="!userDetailForm.headImage" height="80px" :src=userDetailForm.headImage>
...
// 上传头像的的组件向后端发送请求的时候，没有走axios那一套所以token，返回的判断都要自己写
const headers = ref({
...
async function handleUploadSuccess(res) {
  if (res.code !== 1000) {
    ...
    await updateHeadImageService(userUpdateDTO)  // 重新请求后端头像地址
    getUserDetail()
